...
mixin _$HomeScreenCubitState {
  ...
  /// Create a copy of HomeScreenCubitState
...
class _$HomeScreenCubitStateImpl extends _HomeScreenCubitState
    with DiagnosticableTreeMixin {
  _$HomeScreenCubitStateImpl(
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'HomeScreenCubitState(isLoading: $isLoading, hasError: $hasError, userShouldGrantNotificationPermission: $userShouldGrantNotificationPermission, user: $user)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'HomeScreenCubitState'))
...
abstract class _HomeScreenCubitState extends HomeScreenCubitState {
  factory _HomeScreenCubitState(
      {final bool isLoading,
      final bool hasError,
      final bool? userShouldGrantNotificationPermission,
      final ProfessionalUser? user}) = _$HomeScreenCubitStateImpl;
  _HomeScreenCubitState._() : super._();
